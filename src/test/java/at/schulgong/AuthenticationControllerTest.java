...
class AuthenticationControllerTest {
    ...
    //    when(argon2PasswordEncoder.matches(loginDTO.getPassword(),
    // configurationDTO.getPassword())).thenReturn(true);
    //
    ...
    //    when(argon2PasswordEncoder.matches(loginDTO.getPassword(),
    // configurationDTO.getPassword())).thenReturn(false);
    //
    //    ResponseEntity<?> result = authenticationController.authenticate(loginDTO);
    //
    ...
    //    Argon2PasswordEncoder argon2PasswordEncoder = new Argon2PasswordEncoder(16, 32, 1, 60000,
    // 10);
    //

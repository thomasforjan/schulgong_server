...
class AuthenticationControllerTest {
    ...
    @Mock Argon2PasswordEncoder argon2PasswordEncoder;

    @Mock private SecretKeyService secretKeyService;

    SecretKey secretKey;

    @Mock ConfigurationDTO configurationDTO;

    @Mock LoginDTO loginDTO;
    ...
    void testAuthenticate() {
        ...
        when(configurationDTO.getPassword())
                .thenReturn(
                        "$argon2id$v=19$m=60000,t=10,p=1$E4W+ArwtCGSfnrX3DTSJ6g$V2fBKFzAjHy+zhr3t7fHMnVGY1XnFYPFAuTbP3g/Lcs");
        when(argon2PasswordEncoder.matches(loginDTO.getPassword(), configurationDTO.getPassword()))
                .thenReturn(true);

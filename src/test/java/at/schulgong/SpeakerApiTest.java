...
/**
 * Tests for testing the speaker api
 *
...
class SpeakerApiTest {
    ...
    */
    /**
     * Test if all speakers ar discovered by discover function, if speaker are defined in the config
     * file.
     *
     * @throws IOException if method fails
     */
    ...
    */
    /**
     * Test if all speakers ar discovered by discover function, if no speaker are defined in the
     * config file.
     *
     * @throws IOException if method fails
     */
    ...
    */
    /**
     * Test if the first song of the queue is played after the next song from the queue when the
     * last song is currently played.
     *
     * @throws IOException if method fails
     */
    /*
    ...
    */
    /**
     * Test if the last song of the queue is played after the previous song from the queue when the
     * first song is currently played.
     *
     * @throws IOException if method fails
     */
    /*

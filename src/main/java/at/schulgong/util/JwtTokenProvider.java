...
public class JwtTokenProvider {
  ...
  public JwtTokenProvider(SecretKeyService secretKeyService) {
    ...
    this.configurationDTO = ReadWriteConfigurationFile.readConfigurationDTOFromConfigFile(CONFIGURATION_FILE_PATH);
  }
  ...
  public Authentication getAuthentication() {
    UserDetails userDetails = new User("user", "", Collections.singletonList(new SimpleGrantedAuthority("USER")));

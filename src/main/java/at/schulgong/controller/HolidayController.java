...
public class HolidayController {
    ...
    public HolidayController(
            ...
            HolidayModelAssembler assembler) {
                        ...
                        .orElseThrow(
                                () ->
                                        new EntityNotFoundException(
                                                id, Config.HOLIDAY.getException()));
     ...
     */
    @PutMapping("/{id}")
    ResponseEntity<HolidayDTO> replaceHoliday(
            @RequestBody HolidayDTO newHoliday, @PathVariable Long id) {
        ...
        Holiday updateHoliday =
                holidayRepository
                        ...
                        .map(
                                holiday -> {
                                    if (playRingtones.checkLoadHoliday(
                                            DtoConverter.convertHolidayToDTO(holiday))) {

...
public class RingtimeController {
                        ...
                        .orElseThrow(
                                () ->
                                        new EntityNotFoundException(
                                                id, Config.RINGTIME.getException()));
        ...
        Ringtone ringtone =
                ringtoneRepository
                        ...
                        .orElseThrow(
                                () ->
                                        new EntityNotFoundException(
                                                newRingtime.getRingtoneDTO().getId(),
                                                Config.RINGTIME.getException()));
     ...
     */
    @PutMapping("{id}")
    ResponseEntity<RingtimeDTO> replaceRingtime(
            @RequestBody RingtimeDTO newRingtime, @PathVariable long id) {
        ...
        Ringtime updateRingtime =
                ringtimeRepository
                        ...
                        .map(
                                ringtime -> {
                                    if (playRingtones.checkLoadRingtimes(
                                            DtoConverter.convertRingtimeToDTO(ringtime, false))) {
